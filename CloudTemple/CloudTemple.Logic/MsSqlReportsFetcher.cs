namespace CloudTemple.Logic
{
    ...
    public class MsSqlReportsFetcher
    {
        ...
        public MsSqlReportsFetcher()
            : this(new SqlServerData())
        {
        }

        public MsSqlReportsFetcher(ISqlServerData msSqlDataToUse)
        {
        ...
        {
            var allProductInformations =
                this.msSqlData.Purchases.Search(purchase => purchase.Date == date)
        ...
        {
            return
                this.msSqlData.Purchases.Search(purchase => purchase.Product.Name == productName)
        ...
        {
            var allProductInformations =
                this.msSqlData.Purchases.Search(purchase => purchase.Location.Name == locationName)
